 ...
 */
DWObject.LoadImageEx("YOUR-FILE-PATH", Dynamsoft.EnumDWT_ImageType.IT_ALL, onSuccess, onFailure);
```
...
* In your code, create a WebTwain instance like this (read more [here]({{site.indepth}}initialize.html#dynamsoftwebtwainenvcreatedwtobject))
